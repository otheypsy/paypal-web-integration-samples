...
import type { BrowserRouter, RouteObject } from 'react-router-dom'
...
import { createRoutes, createLinks } from './services/router.service.tsx'

const label = 'Integration Samples'
const links = createLinks(appRoutes)
const routes = createRoutes(appRoutes) as Array<RouteObject>
