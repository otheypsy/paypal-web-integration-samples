...
import VaultMutations from '../../schema/mutations/vault';
...
const VaultCreditCard = () => {
    ...
    const onChangeQuery = (id, value) => dispatchQuery({
        key: id, value: value
    });
        ...
        <React.Fragment>
            <div className="row">
                <div className="col-8">
                    <h5>Query</h5>
                    <br />
                    {query.map((value, key) => <InputBody key={key} identifier={key} value={value} onChange={onChangeQuery} />)}
                    <br /><br />
                    <h5>Variables</h5>
                    <br />
                    <OutputJson
