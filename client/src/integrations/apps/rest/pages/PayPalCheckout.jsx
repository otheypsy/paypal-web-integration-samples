...
import { Card, OutputJson, BusyIndicator } from 'pp-framework-react';
...
const PayPalCheckout = () => {
    ...
    const renderPayPalCheckout = () => {
        setIsBusy(true);
        if(!window.hasOwnProperty('PP') || !window.PP.hasOwnProperty('paypal')) return console.error('Unable to load PayPal Checkout SDK - JSV5');
        window.PP.paypal.Buttons({
            createOrder: async () => {
                setIsBusy(true);
