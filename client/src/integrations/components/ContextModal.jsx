...
import { useError, useResetError } from '../states/Error/ErrorHooks';

const ModalContent = () => {

    const appContext = useAppContext();

    return Object.keys(appContext).map(key => <OutputJson key={key} name={key} isCollapsed={true} theme="rjv-default" src={appContext[key]} />);
}
            ...
            <div className="fixed-bottom">
                <nav className="nav">
                    <div className="bg-light p-2">
                        ...
                        <button
                            className="btn btn-sm m-1 btn-outline-warning">
