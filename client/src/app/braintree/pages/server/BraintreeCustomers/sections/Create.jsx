...
import BraintreeCustomersService from '../../../../services/BraintreeCustomersService.jsx'
...
const Create = () => {
    ...
    const createCustomer = async () => {
        ...
        const response = await BraintreeCustomersService.create(appContext.context.integration, {
            ...
            deviceData:
                appContext.context.dataCollectorInstance &&
                (await BraintreeService.dataCollector.getDeviceData(appContext.context.dataCollectorInstance)),
        })
