...
const Create = (props) => {
    ...
    const createVault = async () => {
        ...
        const response = await BraintreeVaultService.create(props.integration, {
            ...
            deviceData: await BraintreeService.dataCollector.getDeviceData(
                braintreeContext.context.dataCollectorInstance,
            ),
        })
    ...
    return (
        <React.Fragment>
            <div className="row">
                ...
                <div className="col-4">
                    <button className="btn btn-outline-success" onClick={createVault}>
                        Create
                    </button>
                </div>
            </div>
